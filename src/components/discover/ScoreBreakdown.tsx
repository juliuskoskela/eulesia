...
export function ScoreBreakdown({ score, breakdown, className = '' }: ScoreBreakdownProps) {
                  ...
                  <div className="text-xs text-gray-500">
                    ...
                    {breakdown.sourceQuality > 1.0 && (
                      <span className="ml-1 text-blue-500">
                        ({breakdown.sourceQuality >= 1.5 ? t('discover.sourceMinutes') :
                          breakdown.sourceQuality >= 1.3 ? t('discover.sourceRss') :
                          breakdown.sourceQuality >= 1.2 ? t('discover.sourceInstitution') :
