...
export function GuideTour() {
  ...
  const { activeGuideId, activeStepIndex, nextStep, prevStep, skipGuide, isGuideActive } = useGuide()
  ...
  const updatePositions = useCallback((rect: DOMRect, preferredPlacement: 'top' | 'bottom' | 'left' | 'right') => {
    setTargetRect(rect)
