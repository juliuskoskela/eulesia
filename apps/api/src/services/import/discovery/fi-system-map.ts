...
export const FI_SYSTEM_MAP: Record<string, FiSystemInfo> = {
  ...
  // Uusimaa
  helsinki: {
    system: "helsinki-paatokset",
    urlOverride:
      "https://paatokset.hel.fi/fi/paattajat/kaupunginvaltuusto/asiakirjat",
    notes:
      "Custom Drupal/Ahjo system. Multi-body: valtuusto, hallitus, lautakunnat.",
  },
  espoo: {
    system: "dynasty",
    urlOverride:
      "https://espoo.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS, not CloudNC",
  },
  vantaa: {
    system: "tweb-new",
    urlOverride: "https://paatokset.vantaa.fi/ktwebscr",
    notes: "Custom domain Tweb (ktwebscr)",
  },
  ...
  turku: {
    system: "none",
    notes: "Custom SPA (paatokset.turku.fi), not supported yet",
  },
  ...
  kouvola: {
    system: "dynasty",
    urlOverride: "https://ep10.kouvola.fi/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "Custom domain ep10",
  },
  kotka: {
    system: "none",
    notes: "CaseM (paatosjulkaisu.kotka.fi), not supported yet",
  },

  // Etelä-Karjala
  lappeenranta: {
    system: "none",
    notes: "M-Files (mfiles.lappeenranta.fi), not supported yet",
  },
  imatra: {
    system: "none",
    notes: "M-Files (mfiles.imatra.fi), not supported yet",
  },
  ...
  joensuu: {
    system: "dynasty",
    urlOverride:
      "https://dynastyjulkaisu.pohjoiskarjala.net/joensuu/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "Regional Dynasty hosting",
  },
  ...
  vaasa: {
    system: "tweb-new",
    urlOverride: "https://tweb.vaasa.fi/ktwebscr",
    notes: "Custom domain Tweb (ktwebscr)",
  },
  ...
  oulu: {
    system: "tweb-new",
    urlOverride: "https://asiakirjat.ouka.fi/ktwebscr",
    notes: "Custom domain Tweb (ouka.fi)",
  },
  ...
  tammela: {
    system: "dynasty",
    urlOverride:
      "https://tammela10.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS",
  },
  jokioinen: {
    system: "tweb",
    urlOverride: "https://jokioinen-julkaisu.triplancloud.fi/",
    notes: "TriPlanCloud",
  },
  humppila: {
    system: "tweb",
    urlOverride: "https://humppila.tweb.fi/ktwebscr/epj_tek_tweb.htm",
    notes: "Alt tweb path",
  },
  ...
  parkano: {
    system: "dynasty",
    urlOverride:
      "https://parkanod10.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS d10",
  },
  ikaalinen: {
    system: "tweb",
    urlOverride: "https://ikaalinen.tweb.fi/ktwebscr/epj_tek_tweb.htm",
    notes: "Alt tweb path",
  },
  ...
  manttavilppula: {
    system: "dynasty",
    urlOverride:
      "https://mantta-vilppulad10.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS d10, hyphenated slug",
  },
  palkane: {
    system: "dynasty",
    urlOverride:
      "https://palkane.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS",
  },
  vesilahti: { system: "cloudnc" },
  urjala: {
    system: "tweb",
    urlOverride: "https://urjala.tweb.fi/ktwebscr/epj_tek_tweb.htm",
    notes: "Alt tweb path",
  },
  punkalaidun: {
    system: "dynasty",
    urlOverride:
      "https://punkalaidun.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS",
  },
  ruovesi: {
    system: "dynasty",
    urlOverride:
      "https://ruovesi.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS, migrated from self-hosted",
  },
  ...
  kuhmoinen: {
    system: "dynasty",
    urlOverride:
      "https://kuhmoinen.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS",
  },
  ...
  asikkala: {
    system: "dynasty",
    urlOverride:
      "https://asikkalad10.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS d10",
  },
  ...
  juva: {
    system: "dynasty",
    urlOverride:
      "https://juva.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS",
  },
  ...
  suonenjoki: {
    system: "dynasty",
    urlOverride:
      "https://www.suonenjoki.info/djulkaisu/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "Dynasty self-hosted",
  },
  ...
  saarijarvi: {
    system: "dynasty",
    urlOverride:
      "https://julkaisu.saarijarvi.fi/saarijarvi10/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "Dynasty self-hosted",
  },
  keuruu: {
    system: "dynasty",
    urlOverride:
      "https://keuruu.oncloudos.com/cgi/DREQUEST.PHP?page=meeting_frames",
    notes: "OnCloudOS",
  },
  ...
  seinajoki: {
    system: "tweb-new",
    urlOverride: "https://listat.seinajoki.fi/ktwebscr",
    notes: "Custom domain Tweb (ktwebscr)",
  },
  ...
  haapajarvi: {
    system: "dynasty",
    urlOverride:
      "https://dynasty.haapajarvi.fi/djulkaisu/cgi/DREQUEST.PHP?page=meeting_frames",
    pathPrefix: "/D10_Haapajarvi",
  },
  ...
  maarianhamina: {
    system: "dynasty",
    confidence: "medium",
    notes: "Åland capital, Swedish: Mariehamn",
  },
  ...
  foglo: {
    system: "dynasty",
    confidence: "medium",
    notes: "Tiny island, may not have online system",
  },
  ...
  sottunga: {
    system: "dynasty",
    confidence: "medium",
    notes: "Pop ~100, smallest in Finland",
  },
...
export const HELSINKI_BODIES = [
  ...
  {
    slug: "kaupunginhallituksen-konsernijaosto",
    name: "Helsinki / Konsernijaosto",
  },
  {
    slug: "kaupunginhallituksen-elinkeinojaosto",
    name: "Helsinki / Elinkeinojaosto",
  },
  {
    slug: "kasvatus-ja-koulutuslautakunta",
    name: "Helsinki / Kasvatus- ja koulutuslautakunta",
  },
  {
    slug: "kaupunkiymparistolautakunta",
    name: "Helsinki / Kaupunkiympäristölautakunta",
  },
  {
    slug: "sosiaali-terveys-ja-pelastuslautakunta",
    name: "Helsinki / Sosiaali-, terveys- ja pelastuslautakunta",
  },
  {
    slug: "kulttuuri-ja-vapaa-aikalautakunta",
    name: "Helsinki / Kulttuuri- ja vapaa-aikalautakunta",
  },
...
export function getMapStats(): {
  ...
  return {
    ...
    highConfidence: entries.filter(
      (e) => !e.confidence || e.confidence === "high",
    ).length,
