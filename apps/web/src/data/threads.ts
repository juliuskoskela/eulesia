    ...
    institutionalContext: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: "The plan covers the area bounded by Hämeenkatu, Satakunnankatu, and the railway station.",
        },
      ],
...
The consultation period runs from January 15 to February 28, 2025.`,
  ...
  },
  {
    ...
    institutionalContext: {
      ...
      faq: [
        {
          q: "What services will the new branch offer?",
          a: "Full library services including book lending, digital services, reading rooms, and community meeting spaces.",
        },
      ],
...
What's the situation like in your neighborhood?`,
  ...
  },
  {
    ...
    institutionalContext: {
      ...
      faq: [
        {
          q: "How does this affect municipalities?",
          a: "Municipalities will receive updated guidance on local climate action plans and potential funding mechanisms.",
        },
        {
          q: "What are the key targets?",
          a: "Carbon neutrality by 2035, with intermediate milestones in 2027 and 2030.",
        },
      ],
...
Your voice matters in creating a fair and effective climate strategy for Finland.`,
  ...
  },
  {
    ...
    institutionalContext: {
      ...
      faq: [
        {
          q: "What are the proposed new hours?",
          a: "Opening at 7:00 AM instead of 8:00 AM, closing at 23:00 instead of 22:00 on weekdays.",
        },
      ],
      contact: "oodi@hel.fi",
    },
...
Would extended hours benefit you? What times are most important to you?`,
  ...
  },
  {
    ...
    authorId: "traficom",
    institutionalContext: {
      docs: [{ title: "Current App Landscape Analysis", url: "#" }],
      timeline: [
