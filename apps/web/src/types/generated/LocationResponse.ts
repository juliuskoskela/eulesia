...
export type LocationResponse = { id: string | null, name: string, nameFi: string | null, nameSv: string | null, nameEn: string | null, displayName: string, osmId: number | null, osmType: string | null, adminLevel: number | null, type: LocationType, country: string | null, latitude: number | null, longitude: number | null, bounds: LocationBounds | null, population: number | null, status: LocationStatus, contentCount: number, parent: LocationParentResponse | null, };
